...
/**
 * Specialized remote datasource for authentication flows.
 *
 * This class keeps the auth layer strict, small, and predictable:
 * - Retrofit call execution
 * - consistent error mapping
 * - typed auth operations
 * - no UI or business logic leakage
 */
