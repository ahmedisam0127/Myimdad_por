...
def main():
    ...
    files_to_find = " BillUiModel.kt, SalesUiEvent.kt, PaymentMethod.kt, PaymentSection.kt, SalesSummary.kt, AppButton.kt, CurrencyFormatter.kt, BigDecimalExtensions.kt, SalesConstants.kt, Dimens.kt, Theme.kt, Color.kt, Shape.kt"
