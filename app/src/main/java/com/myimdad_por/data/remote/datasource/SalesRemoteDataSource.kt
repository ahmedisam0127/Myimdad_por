...
import com.myimdad_por.data.remote.api.InvoiceApiService
...
class SalesRemoteDataSource @Inject constructor(
    ...
    ): NetworkResult<List<SaleInvoiceDto>> {
        return call {
    ...
    suspend fun getInvoice(id: String): NetworkResult<SaleInvoiceDto> {
        return call { apiService.getInvoice(id) }
    }

    suspend fun createInvoice(request: SaleInvoiceDto): NetworkResult<SaleInvoiceDto> {
        return call { apiService.createInvoice(request) }
    }

    suspend fun updateInvoice(id: String, request: SaleInvoiceDto): NetworkResult<SaleInvoiceDto> {
        return call { apiService.updateInvoice(id, request) }
    }

    suspend fun deleteInvoice(id: String): NetworkResult<Unit> {
        return callUnit { apiService.deleteInvoice(id) }
    }

    suspend fun sendInvoice(id: String): NetworkResult<SaleInvoiceDto> {
        return call { apiService.sendInvoice(id) }
    }

    suspend fun <T> call(
        request: suspend InvoiceApiService.() -> Response<T>
    ...
    suspend fun callUnit(
        request: suspend InvoiceApiService.() -> Response<Unit>
    ...
    suspend fun execute(
        request: suspend InvoiceApiService.() -> Response<SaleInvoiceDto>
    ): SaleInvoiceDto {
