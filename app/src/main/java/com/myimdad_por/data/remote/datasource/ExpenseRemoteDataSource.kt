...
import com.myimdad_por.data.remote.api.ExpenseApiService
...
class ExpenseRemoteDataSource(
    ...
    suspend fun getExpense(id: String): NetworkResult<ExpenseDto> {
        return call { apiService.getExpense(id) }
    }

    suspend fun createExpense(request: ExpenseDto): NetworkResult<ExpenseDto> {
        return call { apiService.createExpense(request) }
    }

    suspend fun updateExpense(id: String, request: ExpenseDto): NetworkResult<ExpenseDto> {
        return call { apiService.updateExpense(id, request) }
    }

    suspend fun deleteExpense(id: String): NetworkResult<Unit> {
        return callUnit { apiService.deleteExpense(id) }
    }

    suspend fun <T> call(
        request: suspend ExpenseApiService.() -> Response<T>
    ...
    suspend fun callUnit(
        request: suspend ExpenseApiService.() -> Response<Unit>
    ...
    suspend fun execute(
        request: suspend ExpenseApiService.() -> Response<ExpenseDto>
    ): ExpenseDto {
